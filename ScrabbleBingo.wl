...
(* ::Input:: *)
(*ResourceFunction["Anagrams"]*)


(* ::Input:: *)
(*ResourceFunction[ResourceObject[<|"Name" -> "Anagrams", "ShortName" -> "Anagrams", "UUID" -> "6a65da1c-f661-452e-8778-544a3de283d3", "ResourceType" -> "Function", "Version" -> "1.0.0", "Description" -> "Find all the anagrams of a word", "RepositoryLocation" -> URL["https://www.wolframcloud.com/obj/resourcesystem/api/1.0"], "SymbolName" -> "FunctionRepository`$cd831c0a173343ffa571ffa7bd60524c`Anagrams", "FunctionLocation" -> CloudObject["https://www.wolframcloud.com/obj/0ccfc2c8-0a38-446b-bee4-89ac260db429"]|>, {ResourceSystemBase -> "https://www.wolframcloud.com/obj/resourcesystem/api/1.0"}]]["Seating"]*)
